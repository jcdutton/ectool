...
int cmd_charge_get_regs(int argc, char *argv[])
{
	...
	if (argc == 2) {
		...
		uint16_t control2 = r.regs[ISL9241REG3D];
		uint16_t control3 = r.regs[ISL9241REG4C];
		uint16_t control4 = r.regs[ISL9241REG4E];
		uint16_t control7 = r.regs[ISL9241REG38];
		printf("control0: 0x%04X\n", control0);
		printf("control1: 0x%04X\n", control1);
		printf("control2: 0x%04X\n", control2);
		printf("control3: 0x%04X\n", control3);
		printf("control4: 0x%04X\n", control4);
		printf("control7: 0x%04X\n", control7);
		...
		printf("Two-level Adapter Current Limit: %s\n", (control2 & (1 << 12)) ? "On" : "Off");
